...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crear nuevo rol' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del rol', type: Number }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Buscar rol por descripción' }),
    (0, swagger_1.ApiParam)({ name: 'description', description: 'Descripción del rol', type: String }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Rol encontrado' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Rol no encontrado' }),
    ...
    __metadata("design:returntype", void 0)
], RolesController.prototype, "findByDescription", null);
exports.RolesController = RolesController = __decorate([
    (0, swagger_1.ApiTags)('03 - Roles Management'),
