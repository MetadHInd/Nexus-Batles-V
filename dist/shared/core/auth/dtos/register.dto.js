...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'John', description: 'Nombre del usuario', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], RegisterDto.prototype, "userName", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Doe', description: 'Apellido del usuario', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], RegisterDto.prototype, "userLastName", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2, description: 'ID del rol (por defecto: User)', required: false }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], RegisterDto.prototype, "role_idrole", void 0);
