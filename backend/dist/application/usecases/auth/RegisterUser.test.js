...
const RegisterUser_1 = require("../../../../src/application/usecases/auth/RegisterUser");
const mockRepo = {
    findByEmail: jest.fn(),
    findByApodo: jest.fn(),
    findById: jest.fn(),
...
describe('RegisterUser', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        useCase = new RegisterUser_1.RegisterUser(mockRepo, mockHasher, mockToken, mockEmail);
    });
    it('debe registrar usuario nuevo y devolver user + token', async () => {
        ...
        expect(mockToken.generate).toHaveBeenCalledWith(expect.objectContaining({ email: 'juan@test.com', apodo: 'juanp' }));
    });
...
//# sourceMappingURL=RegisterUser.test.js.map