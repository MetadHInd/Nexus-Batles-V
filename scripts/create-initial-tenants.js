...
function createInitialTenants() {
    return __awaiter(this, void 0, void 0, function () {
        var tenants, _i, tenants_1, tenantData, exists, tenant, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tenantData = tenants_1[_i];
                    return [4 /*yield*/, prisma.tenants.findUnique({
                            where: { slug: tenantData.slug },
                        })];
                case 2:
                    exists = _a.sent();
                    if (exists) {
                        console.log("\u26A0\uFE0F  Tenant '".concat(tenantData.slug, "' ya existe (tenant_sub: ").concat(exists.tenant_sub, ")"));
                        return [3 /*break*/, 4];
                    }
                ...
                case 3:
                    tenant = _a.sent();
                    console.log("\u2705 Tenant creado: ".concat(tenant.slug));
                    console.log("   \uD83D\uDCE7 Name: ".concat(tenant.name));
                    console.log("   \uD83D\uDD11 Tenant Sub: ".concat(tenant.tenant_sub));
                    console.log("   \uD83C\uDFF7\uFE0F  Slug: ".concat(tenant.slug));
                    console.log('');
                    _a.label = 4;
                case 4:
                    _i++;
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('❌ Error al crear tenants:', error_1);
                    throw error_1;
