...
var PricingRules = /** @class */ (function () {
     ...
     */
    PricingRules.calculateTax = function (base, taxRule) {
     ...
     */
    PricingRules.calculateDiscount = function (base, discountRule) {
        if (!discountRule)
            return Money_1.Money.zero(base.currency);
        ...
        if (discountRule.type === 'FIXED') {
            var fixed = new Money_1.Money(discountRule.value, base.currency);
            // El descuento no puede superar el precio base
            return fixed.amountInCents > base.amountInCents ? base : fixed;
        }
        throw new Error("PricingRules: unknown discount type: ".concat(discountRule.type));
    };
    /**
     * Calcula el total final: base + tax − discount
     */
    PricingRules.calculateTotal = function (base, tax, discount) {
