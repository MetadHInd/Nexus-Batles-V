...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.logger.log("\u2705 Conectado en ".concat(connectTime, "ms"));
                            return [3 /*break*/, 3];
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error('❌ Error inicializando:', error_1);
                            throw error_1;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_2 = _a.sent();
                            this.logger.error('❌ Error desconectando:', error_2);
                            return [3 /*break*/, 4];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.client.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT 1"], ["SELECT 1"])))];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, {
                                    status: 'healthy',
         ...
         */
        PrismaService_1.prototype.performanceTest = function () {
            return __awaiter(this, void 0, void 0, function () {
                var start1, simpleQueryTime, start2, countQueryTime;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.client) {
                            ...
                            start1 = Date.now();
                            return [4 /*yield*/, this.client.$queryRaw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["SELECT 1"], ["SELECT 1"])))];
                        case 1:
                            _a.sent();
                            simpleQueryTime = Date.now() - start1;
                            start2 = Date.now();
                            return [4 /*yield*/, this.client.sysUser.count()];
                        case 2:
                            _a.sent();
                            countQueryTime = Date.now() - start2;
                            return [2 /*return*/, {
                                    simpleQuery: "".concat(simpleQueryTime, "ms"),
                                    countQuery: "".concat(countQueryTime, "ms"),
                                    status: 'OK',
                                    multiTenancy: 'disabled'
                                }];
                    }
