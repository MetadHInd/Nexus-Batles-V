...
var firestore_messaging_service_1 = require("./firestore-messaging.service");
var messaging_history_controller_1 = require("./controllers/messaging-history.controller");
var DatabaseModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            controllers: [messaging_history_controller_1.MessagingHistoryController],
            providers: [
                prisma_service_1.PrismaService,
                firestore_service_1.FirestoreService,
                firestore_messaging_service_1.FirestoreMessagingService,
            ],
            exports: [prisma_service_1.PrismaService, firestore_service_1.FirestoreService, firestore_messaging_service_1.FirestoreMessagingService],
        })];
