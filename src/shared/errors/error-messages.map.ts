...
export const ErrorMessages: Record<ErrorCodesEnum, string> = {
  ...
  [ErrorCodesEnum.NON_AUTHORITATIVE_INFORMATION]:
  ...
  [ErrorCodesEnum.PROXY_AUTHENTICATION_REQUIRED]:
  ...
  [ErrorCodesEnum.REQUEST_HEADER_FIELDS_TOO_LARGE]:
    'Request Header Fields Too Large',
  [ErrorCodesEnum.UNAVAILABLE_FOR_LEGAL_REASONS]:
  ...
  [ErrorCodesEnum.NETWORK_AUTHENTICATION_REQUIRED]:
