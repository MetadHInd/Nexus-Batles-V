...
var UsersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('02 - Users Management'), (0, common_1.Controller)('api/users'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.listUsers = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.listUsers(dto)];
                });
            });
        };
        UsersController_1.prototype.getUserById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.getUserById(id)];
                });
            });
        };
        UsersController_1.prototype.getUserByUuid = function (uuid) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.getUserByUuid(uuid)];
                });
            });
        };
        UsersController_1.prototype.updateUser = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersController_1.prototype.changePassword = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.changePassword(id, dto)];
                });
            });
        };
    ...
    (function () {
        ...
        _listUsers_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({
        ...
        _getUserById_decorators = [(0, common_1.Get)(':id'), (0, swagger_1.ApiOperation)({
                summary: 'Obtener usuario por ID',
                description: 'Retorna la información detallada de un usuario específico'
            }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del usuario', type: Number }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario encontrado' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' })];
        _getUserByUuid_decorators = [(0, common_1.Get)('uuid/:uuid'), (0, swagger_1.ApiOperation)({
                summary: 'Obtener usuario por UUID',
                description: 'Retorna la información detallada de un usuario usando su UUID'
            }), (0, swagger_1.ApiParam)({ name: 'uuid', description: 'UUID del usuario', type: String }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario encontrado' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' })];
        _updateUser_decorators = [(0, common_1.Put)(':id'), (0, swagger_1.ApiOperation)({
                summary: 'Actualizar usuario',
                description: 'Actualiza la información de un usuario existente'
            }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del usuario', type: Number }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario actualizado exitosamente' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' }), (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos inválidos o email ya en uso' })];
        _deleteUser_decorators = [(0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({
            ...
            }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del usuario', type: Number }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario desactivado exitosamente' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' })];
        _changePassword_decorators = [(0, common_1.Put)(':id/change-password'), (0, swagger_1.ApiOperation)({
                summary: 'Cambiar contraseña de usuario',
                description: 'Permite a un usuario cambiar su contraseña actual por una nueva'
            }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del usuario', type: Number }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Contraseña cambiada exitosamente' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Contraseña actual incorrecta' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' })];
