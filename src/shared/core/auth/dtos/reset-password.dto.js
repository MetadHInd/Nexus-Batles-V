...
exports.ResetPasswordDto = exports.RequestResetPasswordDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var RequestResetPasswordDto = function () {
    var _a;
    var _userEmail_decorators;
    var _userEmail_initializers = [];
    var _userEmail_extraInitializers = [];
    return _a = /** @class */ (function () {
            function RequestResetPasswordDto() {
...
var ResetPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _token_decorators = [(0, swagger_1.ApiProperty)({ example: 'abc123token', description: 'Token de recuperación' }), (0, class_validator_1.IsString)()];
            _newPassword_decorators = [(0, swagger_1.ApiProperty)({ example: 'newPassword123', description: 'Nueva contraseña (mínimo 6 caracteres)' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(6)];
