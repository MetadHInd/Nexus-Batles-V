...
var message_formatter_1 = require("../../../../../../../../../../src/shared/utils/message-formatter");
var PasswordService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var PasswordService = _classThis = /** @class */ (function () {
        function PasswordService_1() {
        }
        PasswordService_1.prototype.hashPassword = function (password) {
            return __awaiter(this, void 0, void 0, function () {
                var requiredLength, salt;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            requiredLength = Number(config_constants_enum_1.ConfigConstants.PASSWORD_REQUIRED_SIZE);
        ...
        PasswordService_1.prototype.validatePassword = function (plain, hashed) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.compare(plain, hashed)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        return PasswordService_1;
    }());
