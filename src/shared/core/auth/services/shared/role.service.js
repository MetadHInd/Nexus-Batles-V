...
var RoleService = function () {
    ...
    var RoleService = _classThis = /** @class */ (function () {
        function RoleService_1() {
        }
        RoleService_1.prototype.validate = function (user, allowedRoles) {
            if (!user || !allowedRoles.includes(user.role)) {
                throw new common_1.ForbiddenException(generic_error_messages_enum_1.GenericErrorMessages.FORBIDDEN_ACCESS);
            }
        };
