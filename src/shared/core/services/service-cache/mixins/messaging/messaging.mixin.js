...
var messaging_provider_factory_1 = require("../../../../messaging/utils/messaging-provider.factory");
...
function WithMessaging(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.getAvailableProviders = function () {
            if (!this.messagingFactory) {
                return [];
            }
            return this.messagingFactory.getAvailableProviders();
        };
        class_1.prototype.sendByProvider = function (provider, message) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            service = this.messagingFactory.getProvider(provider);
