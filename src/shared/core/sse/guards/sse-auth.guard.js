 ...
 */
var SSEAuthGuard = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var SSEAuthGuard = _classThis = /** @class */ (function () {
        function SSEAuthGuard_1(jwtService) {
            this.jwtService = jwtService;
            this.logger = new common_1.Logger(SSEAuthGuard.name);
        }
        SSEAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, payload, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!token) {
                                this.logger.warn("SSE auth failed: No token provided (IP: ".concat(request.ip, ")"));
                        ...
                        case 2:
                            ...
                            this.logger.debug("SSE auth successful: ".concat(payload.sub || payload.userId, " (IP: ").concat(request.ip, ")"));
                            return [2 /*return*/, true];
                        case 3:
                            error_1 = _a.sent();
                            this.logger.warn("SSE auth failed: Invalid token (IP: ".concat(request.ip, ")"), error_1 instanceof Error ? error_1.message : '');
         ...
         */
        SSEAuthGuard_1.prototype.extractToken = function (request) {
        ...
        return SSEAuthGuard_1;
    }());
    __setFunctionName(_classThis, "SSEAuthGuard");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        SSEAuthGuard = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SSEAuthGuard = _classThis;
}();
