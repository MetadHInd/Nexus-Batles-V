...
var WhatsAppService = function () {
    ...
    var WhatsAppService = _classThis = /** @class */ (function () {
        ...
        WhatsAppService_1.prototype.send = function (message) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("WhatsApp send to: ".concat(message.to));
                    return [2 /*return*/, {
                            success: true,
                            messageId: "wa_".concat(Date.now()),
                            provider: 'twilio',
        ...
        WhatsAppService_1.prototype.sendInteractive = function (message) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("WhatsApp interactive send to: ".concat(message.to));
                    return [2 /*return*/, {
                            success: true,
                            messageId: "wa_interactive_".concat(Date.now()),
                            provider: 'twilio',
                            timestamp: new Date().toISOString(),
                        }];
                });
