...
interface OrderGroupItem {
  ...
  selections?: string[]; // Para mostrar selecciones internas
}
...
interface PaymentOrderEmailContext {
  ...
  currentPaymentUrl: string; // URL del payment order
  includePaymentButton?: boolean; // Si incluir el botón de pago
}

export const getOrderConfirmationWithGroupsEmail = (
  to: string,
