...
var SmsService = function () {
    ...
    var SmsService = _classThis = /** @class */ (function () {
        ...
        SmsService_1.prototype.send = function (message) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("SMS send to: ".concat(message.to));
                    // Delegar a Twilio service si está disponible
                    return [2 /*return*/, {
                            success: true,
                            messageId: "sms_".concat(Date.now()),
                            provider: 'twilio',
        ...
        SmsService_1.prototype.sendBulk = function (messages) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.all(messages.map(function (msg) { return _this.send(msg); }))];
                });
            });
        };
        return SmsService_1;
