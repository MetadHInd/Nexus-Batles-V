...
var whatsapp_module_1 = require("./whatsapp/whatsapp.module");
var messaging_provider_factory_1 = require("./utils/messaging-provider.factory");
var messaging_controller_1 = require("./controllers/messaging.controller");
var message_logger_service_1 = require("./services/message-logger.service");
/**
...
var MessagingModule = function () {
    ...
    var _classThis;
    var MessagingModule = _classThis = /** @class */ (function () {
        function MessagingModule_1() {
        }
        return MessagingModule_1;
    }());
    __setFunctionName(_classThis, "MessagingModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        MessagingModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MessagingModule = _classThis;
}();
