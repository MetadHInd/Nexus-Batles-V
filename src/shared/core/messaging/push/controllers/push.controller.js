...
var push_dtos_1 = require("../dtos/push-dtos");
var PushController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('08 - Push Notifications'), (0, common_1.Controller)('api/messaging/push'), (0, common_1.UseGuards)(role_guard_1.RoleGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var PushController = _classThis = /** @class */ (function () {
        ...
        PushController_1.prototype.send = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            message = __assign(__assign({}, dto), { scheduleFor: dto.scheduleFor ? new Date(dto.scheduleFor) : undefined });
                            ...
                            return [4 /*yield*/, this.pushService.send(message)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_1 = _a.sent();
                            console.error('Error en el controlador de push:', error_1);
                            throw error_1;
        ...
        PushController_1.prototype.sendBulk = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var messages;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            messages = dto.messages.map(function (msg) { return (__assign(__assign({}, msg), { scheduleFor: msg.scheduleFor ? new Date(msg.scheduleFor) : undefined })); });
                            return [4 /*yield*/, this.pushService.sendBulk(messages)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _send_decorators = [(0, common_1.Post)('send'), (0, swagger_1.ApiOperation)({ summary: 'Enviar una notificación push' }), (0, swagger_1.ApiBody)({ type: push_dtos_1.SendPushDto }), (0, swagger_1.ApiResponse)({
                status: 200,
        ...
        _sendBulk_decorators = [(0, common_1.Post)('send-bulk'), (0, swagger_1.ApiOperation)({ summary: 'Enviar múltiples notificaciones push' }), (0, swagger_1.ApiBody)({ type: push_dtos_1.SendBulkPushDto }), (0, swagger_1.ApiResponse)({
                status: 200,
