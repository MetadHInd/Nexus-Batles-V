...
var UserGateway = function () {
    ...
    var UserGateway = _classThis = /** @class */ (function (_super) {
        __extends(UserGateway_1, _super);
        function UserGateway_1() {
            var _this = _super.call(this) || this;
            // Registrar handler para USER_MESSAGE
            _this.on(socket_events_types_1.SocketEventTypes.USER_MESSAGE, function (payload, client) {
                return _this.handleUserMessage(payload, client);
            });
            return _this;
        }
        UserGateway_1.prototype.handleUserMessage = function (payload, client) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log(client.id, 'connected');
                    // Lógica para manejar mensajes de usuario
                    console.log("[UserGateway] Mensaje de ".concat(payload.userId, ": ").concat(payload.message));
